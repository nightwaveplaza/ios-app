...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/BugfenderSDK/BugfenderSDK.xcframework" "" "true" "ios-x86_64-maccatalyst/BugfenderSDK.framework" "ios-i386_x86_64-simulator/BugfenderSDK.framework" "ios-armv7_arm64/BugfenderSDK.framework"
fi
