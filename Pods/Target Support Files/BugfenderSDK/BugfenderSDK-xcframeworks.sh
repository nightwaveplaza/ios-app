...
install_xcframework "${PODS_ROOT}/BugfenderSDK/BugfenderSDK.xcframework" "BugfenderSDK" "framework" "ios-arm64_x86_64-simulator" "ios-arm64_x86_64-maccatalyst" "ios-arm64_armv7"
